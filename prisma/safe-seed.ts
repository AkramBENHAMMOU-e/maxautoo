...
async function main() {
  // Nous n'essayons pas de supprimer les données d'abord
  ...
  try {
    ...
    // Si nous avons des erreurs dues à des données existantes, nous les ignorons
    console.error('Erreur lors du remplissage de la base de données, probablement car certaines données existent déjà:', error);
    console.log('Continuez avec ce qui a été créé avec succès.');
  }
}
